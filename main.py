...
def run_flask():
    # Прив'язка до порту із змінної середовища PORT
    port = int(os.environ.get("PORT", 10000))  # За замовчуванням порт 10000
    logger.info(f"Flask сервер працює на порту {port}")
